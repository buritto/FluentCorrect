...
namespace ObjectPrinting
{
    public class PrintingConfig<TOwner>
    {
        ...
        public List<string> ExcludePropert = new List<string>();
        public Dictionary<Type, Func<object, string>> SerializationFuncsForDifferentType = new Dictionary<Type, Func<object, string>>();
        public Dictionary<Type, CultureInfo> CultureForDifferentNumberBase = new Dictionary<Type, CultureInfo>();
        public Dictionary<string, Func<object, string>> SerializationFuncsForDifferentProperty = new Dictionary<string, Func<object, string>>();
