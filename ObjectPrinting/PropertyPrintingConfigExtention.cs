...
namespace ObjectPrinting
{
    ...
    {
        private static PrintingConfig<TOwner> AddCulture<TOwner>(PrintingConfig<TOwner> printingConfig,
            CultureInfo culture,
            Type type)
        {
        ...
        {
            return AddCulture(((IPropertyPrintingConfig<int, TOwner>) propertyPrintingConfig).Config, culture,
                typeof(int));
        }
